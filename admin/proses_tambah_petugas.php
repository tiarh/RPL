...
if($_POST){
    ...
    if(empty($nama_petugas)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into petugas (nama_petugas, username, password, level) value ('".$nama_petugas."','".$username."','".md5($password)."','".$id_petugas."')") or die(mysqli_error($conn));
        if($insert){
